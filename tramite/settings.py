"""
Django settings for tramite project.
...
SECRET_KEY = '+xg6l3aamq4fiujn=p9ml0hl7l()b9$oomi@)^c$z5ufrbrprx'
...
WSGI_APPLICATION = 'tramite.wsgi.application'
